...
func (c *sendServiceClient) Send(ctx context.Context, opts ...grpc.CallOption) (SendService_SendClient, error) {
	stream, err := c.cc.NewStream(ctx, &SendService_ServiceDesc.Streams[0], "/SendService/send", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *sendServiceSendClient) Send(m *RequestMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *sendServiceSendClient) CloseAndRecv() (*ResponseMessage, error) {
...
func (x *sendServiceSendServer) SendAndClose(m *ResponseMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *sendServiceSendServer) Recv() (*RequestMessage, error) {
